...
#define ADC_TIMER						(((ADC_DATA_RATE == ADC_DATA_RATE_5) && (ADC_CONVERSION_MODE == ADC_CONVERSION_CONTINUOUS))  ?   17: \
...
void adc_init()
{
  ...
  // Check the data rate
#if ADC_CONVERSION_MODE == ADC_CONVERSION_CONTINUOUS && (ADC_DATA_RATE == ADC_DATA_RATE_1 || ADC_DATA_RATE == ADC_DATA_RATE_2 || ADC_DATA_RATE == ADC_DATA_RATE_3 || ADC_DATA_RATE == ADC_DATA_RATE_4)
