...
static int spim_nrf52_init(struct device *dev)
{
	...
	spim->PSEL.SCK 	= config->psel.sck | ((config->port << SPIM_PSEL_SCK_PORT_Pos) & SPIM_PSEL_SCK_PORT_Msk);
	spim->PSEL.MOSI = config->psel.mosi | ((config->port << SPIM_PSEL_MOSI_PORT_Pos) & SPIM_PSEL_MOSI_PORT_Msk);
	spim->PSEL.MISO = config->psel.miso | ((config->port << SPIM_PSEL_MISO_PORT_Pos) & SPIM_PSEL_MISO_PORT_Msk);
...
// 	.base = NRF_SPIM2,
// 	.irq_config_func = spim_nrf52_config_func_2,
// 	.default_cfg = {
// 		.config = CONFIG_SPI_2_DEFAULT_CFG,
// 		.max_sys_freq = CONFIG_SPI_2_DEFAULT_BAUD_RATE,
// 	},
//         .port = CONFIG_SPIM2_NRF52_GPIO_PORT,
// 	.psel = {
// 		.sck = CONFIG_SPIM2_NRF52_GPIO_SCK_PIN,
// 		.mosi = CONFIG_SPIM2_NRF52_GPIO_MOSI_PIN,
// 		.miso = CONFIG_SPIM2_NRF52_GPIO_MISO_PIN,
// 		.ss = { CONFIG_SPIM2_NRF52_GPIO_SS_PIN_0,
// 			CONFIG_SPIM2_NRF52_GPIO_SS_PIN_1,
// 			CONFIG_SPIM2_NRF52_GPIO_SS_PIN_2,
// 			CONFIG_SPIM2_NRF52_GPIO_SS_PIN_3 },
// 	},
// 	.orc = CONFIG_SPIM2_NRF52_ORC,
// };
//
// static struct spim_nrf52_data spim_nrf52_data_2;
//
// DEVICE_AND_API_INIT(spim_nrf52_2, CONFIG_SPI_2_NAME, spim_nrf52_init,
// 		    &spim_nrf52_data_2, &spim_nrf52_config_2,
// 		    POST_KERNEL, CONFIG_KERNEL_INIT_PRIORITY_DEVICE,
// 		    &spim_nrf52_driver_api);
//
// static void spim_nrf52_config_func_2(struct device *dev)
// {
// 	IRQ_CONNECT(NRF5_IRQ_SPI2_IRQn, CONFIG_SPI_2_IRQ_PRI,
// 		    spim_nrf52_isr, DEVICE_GET(spim_nrf52_2), 0);
//
// 	irq_enable(NRF5_IRQ_SPI2_IRQn);
// }
