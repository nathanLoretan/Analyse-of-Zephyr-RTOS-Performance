...
#define DEFINE_IBLE_UUID128(_uuid, _base...)		BT_UUID_DECLARE_128(BYTE1(_base, N), BYTE2(_base, N), BYTE3(_base, N), BYTE4(_base, N), BYTE5(_base, N), BYTE6(_base, N),      \
                                                                    BYTE7(_base, N), BYTE8(_base, N), BYTE9(_base, N), BYTE10(_base, N), BYTE11(_base, N), BYTE12(_base, N),   \
                                                                    BYTE13(_base, N), BYTE14(_base, N), ((_uuid & 0xFF00) >> 8), (_uuid & 0x00FF))
