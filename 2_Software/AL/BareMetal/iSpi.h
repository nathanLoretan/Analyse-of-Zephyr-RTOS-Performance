...
#define ISPI_MODE_SCK_HIGH_CAPTURE_L_TO_H		NRF_DRV_SPI_MODE_0
#define ISPI_MODE_SCK_HIGH_CAPTURE_H_TO_L		NRF_DRV_SPI_MODE_1
#define ISPI_MODE_SCK_LOW_CAPTURE_L_TO_H		NRF_DRV_SPI_MODE_2
#define ISPI_MODE_SCK_LOW_CAPTURE_H_TO_L		NRF_DRV_SPI_MODE_3
