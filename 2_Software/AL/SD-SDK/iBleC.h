...
/**
 * @brief SD+SDK BLE central interface
 * @{
 */
 ...
 *	data					data to write
 *	write_params	SD write parameters
 */
struct iBleC_write_params_t {
 ...
 *	length						data to write length
 *	data							data to write
 *	subscribe_params	SD+SDK subscribe parameters
 */
struct iBleC_notify_params_t{
 ...
 *
 * conn_ref		SoftDevice connection reference
