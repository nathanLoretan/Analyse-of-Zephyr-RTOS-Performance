...
#define BLE_INDICATE_RSP_PIN    11
#define BLE_INDICATE_RSP_PORT   NRF_P1
...
// Zephyr:
//  -> iBle_read_handler()
#define BLE_READ_PIN            12
#define BLE_READ_PORT           NRF_P1
#define BLE_READ()              DEBUG_PIN_TOGGLE(BLE_READ_PIN, BLE_READ_PORT)

//  -> iBle_write_handler_t
#define BLE_WRITE_PIN           13
#define BLE_WRITE_PORT          NRF_P1
