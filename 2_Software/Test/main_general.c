...
DEFINE_IBLEP_SVC_CONFIG(cts_config)
{
  ...
  (
    DEFINE_IBLEP_CHRC (
      ...
      IBLEP_ATTR_CONFIG(DEFINE_IBLEP_UUID16(BT_UUID_CTS_CURRENT_TIME), IBLEP_GATT_PERM_READ | IBLEP_GATT_PERM_WRITE, &current_time)
    ),
  )
};
  ...
  (
    ...
    DEFINE_IBLEP_CHRC_NO_CCCD (
      IBLEP_CHRC_CONFIG(DEFINE_IBLEP_UUID16(BT_UUID_HRS_BODY_SENSOR), IBLEP_CHRC_PERM_READ),
    	IBLEP_ATTR_CONFIG(DEFINE_IBLEP_UUID16(BT_UUID_HRS_BODY_SENSOR), IBLEP_GATT_PERM_READ, NULL)
    ),
    DEFINE_IBLEP_CHRC_NO_CCCD (
      IBLEP_CHRC_CONFIG(DEFINE_IBLEP_UUID16(BT_UUID_HRS_CONTROL_POINT), IBLEP_CHRC_PERM_WRITE),
    	IBLEP_ATTR_CONFIG(DEFINE_IBLEP_UUID16(BT_UUID_HRS_CONTROL_POINT), IBLEP_GATT_PERM_READ, NULL)
    )
  )
};
...
DEFINE_IBLEP_SVC_CONFIG(my_config)
{
  ...
  (
    DEFINE_IBLEP_CHRC_NO_CCCD (
    	IBLEP_CHRC_CONFIG(DEFINE_IBLEP_UUID128(MY_UUID_CHRC, MY_UUID_BASE), IBLEP_CHRC_PERM_READ | IBLEP_CHRC_PERM_WRITE),
      IBLEP_ATTR_CONFIG(DEFINE_IBLEP_UUID128(MY_UUID_CHRC, MY_UUID_BASE), IBLEP_GATT_PERM_READ | IBLEP_GATT_PERM_WRITE, &current_time)
    ),
  )
};
...
void bluetooth_init()
{
  ...
  iBleP_init();
  iBleP_svc_init(&cts_svc, cts_config, cts_nbr_attrs, cts_nbr_chrcs);
  iBleP_svc_init(&hrs_svc, hrs_config, hrs_nbr_attrs, hrs_nbr_chrcs);
  iBleP_svc_init(&my_svc, my_config, my_nbr_attrs, my_nbr_chrcs);
